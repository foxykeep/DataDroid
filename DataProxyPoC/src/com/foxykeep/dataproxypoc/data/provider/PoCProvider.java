...
public class PoCProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.foxykeep.dataproxypoc.data.provider.PoCProvider";
    ...
    public String getType(final Uri uri) {
        ...
        switch (match) {
            case PERSON_ID:
                return "vnd.android.cursor.item/com.foxykeep.dataproxypoc.data.provider.person";
            case PERSON:
                return "vnd.android.cursor.dir/com.foxykeep.dataproxypoc.data.provider.person";
            default:
                throw new IllegalArgumentException("Unknown URI " + uri);
        }
    }
