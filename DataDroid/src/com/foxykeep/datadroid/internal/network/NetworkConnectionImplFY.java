...
/**
 * Implementation of {@link NetworkConnection2} for Froyo devices.
 * 
 * @author Foxykeep
 * @see NetworkConnectionImplGB
 */
public final class NetworkConnectionImplFY {

    private NetworkConnectionImplFY() {
    ...
    public static WebserviceResult execute(String url, Method method,
        ...
        // TODO add implementation based on DefaultHttpClient or AndroidHttpClient.
        return null;
    }
}
