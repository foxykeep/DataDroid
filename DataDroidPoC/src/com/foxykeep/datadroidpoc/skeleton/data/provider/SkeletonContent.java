...
/**
 * {@link SkeletonContent} is the superclass of the various classes of content stored by
 * {@link SkeletonProvider}.
 * <p>
...
public abstract class SkeletonContent {
    ...
    public static final class Skeleton extends SkeletonContent implements SkeletonColumns,
        ...
        public static final Uri CONTENT_URI = Uri.parse(SkeletonContent.CONTENT_URI + "/"
                + TABLE_NAME);
        ...
        // TODO : Add constants for the selection/sort order you will use in your project
        ...
        // TODO : Add incremental constant to get the columns in the content projection below
        ...
        // TODO : Add the other projections (if any) you will use using the same model as the
        // content projection

        // TODO : The following 2 methods are used for creation and upgrade of a table.
        static void createTable(final SQLiteDatabase db) {
            final String s = " (" + _ID + " integer primary key autoincrement, " + COLUMN_NAME_ONE
                    + " text, " + COLUMN_NAME_TWO + " integer, "
                    + COLUMN_NAME_THREE + " integer " + ");";

            db.execSQL("create table " + TABLE_NAME + s);

            // TODO : Add the table's indexes (if any) using the getCreateIndexString() method
