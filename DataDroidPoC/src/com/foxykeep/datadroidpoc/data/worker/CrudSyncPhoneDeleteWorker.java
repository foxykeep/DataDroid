...
public class CrudSyncPhoneDeleteWorker {
    ...
    public static Bundle start(final String userId, final String phoneIdList) throws IllegalStateException, IOException, URISyntaxException,
        ...
        NetworkConnectionResult wsResult = NetworkConnection.retrieveResponseFromService(WSConfig.WS_CRUD_PHONE_DELETE_URL,
